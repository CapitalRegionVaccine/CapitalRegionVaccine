...
<!--start: status pages-->
**Last Updated**: 2021-03-28 05:30 AM
...
| <img alt="" src="https://favicons.githubusercontent.com/www.walgreens.com" height="13"> [Walgreens](https://www.walgreens.com/findcare/vaccination/covid-19/location-screening)         | :white_check_mark: Available Mechanicville (0) Halfmoon (0) Ballston Lake (0) Hoosick Falls (0) Latham (4) Watervliet (8) Saratoga Springs (0) Saratoga Springs (0) Loudonville (10) Schenectady (8) Colonie (5) Albany (18) Rotterdam (0) Guilderland (5)       |
